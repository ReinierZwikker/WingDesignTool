...
def save_wingbox_definition():
    ...
    wingbox_definition = {'length': halfspan,
                          ...
                          'top_stringer_lim_point_1': 10,
                          'top_number_of_stringers_1': 20,
                          'top_stringer_lim_point_2': 20,
                          'top_number_of_stringers_2': 20,
                          'top_number_of_stringers_3': 15,
                          'top_stringer_area': 0.0011,
                          'bottom_stringer_lim_point_1': 10,
                          'bottom_number_of_stringers_1': 16,
                          'bottom_stringer_lim_point_2': 20,
                          'bottom_number_of_stringers_2': 10,
                          'bottom_number_of_stringers_3': 10,
                          'bottom_stringer_area': 0.0011,
                          'spar_thickness': 0.045,
