...
W = mtow/9.81/0.454 #weight in lb
n_max = 2.1 + (24000)/(W + 10000) #max load factor

V_EAS = np.arange(0, 250) #xaxis
...
V_F = 160 #not correct design flap speed

n_min = -1 #CS25
n_0A = np.power((V_EAS/V_s1), 2)
n_02 = np.power((V_EAS/V_s0), 2)
n_0H = -np.power((V_EAS/V_s1), 2)
