...
length_top_plate = (right_top_corner_wingbox[0] - left_top_corner_wingbox[0]) * chord_length
...
length_bottom_plate = math.sqrt(length_top_plate**2 + (height_front_spar-height_back_spar)**2)
...
x_top_bottom_plate = left_top_corner_wingbox[0] * chord_length + length_top_plate/2
...
z_centroid = calculate_z_coordinate_centroid()
print(x_centroid)
...
#y coordinate centroid (wr LE-chord intersection)
