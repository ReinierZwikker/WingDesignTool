...
def centroid(location, t1, t2, t3, t4):
    ...
    return wingbox_centroid_location

#print(centroid(26, 1,1,1,1))
#print(centroid(0, 1,1,1,1))
#print(centroid(26, 0.1, 0.1,0.1,0.1))
#print(centroid(0, 0.1, 0.1 ,0.1, 0.1))
